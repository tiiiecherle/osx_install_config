...
###
### launchd & applescript to do things on every boot
###
...
sudo rm -f /Library/Scripts/run_on_boot_as_root.sh
sudo cp -a "$SCRIPT_DIR"/install_files/run_on_boot_as_root.sh /Library/Scripts/run_on_boot_as_root.sh
sudo chown root:wheel /Library/Scripts/run_on_boot_as_root.sh
sudo chmod 755 /Library/Scripts/run_on_boot_as_root.sh
