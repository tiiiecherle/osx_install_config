...
# add bonjour to bookmarks
defaults write com.apple.Safari BookmarksMenuIncludesRendezvous -bool false

# disable add bonjour to favorites
if [[ -z $(/usr/libexec/PlistBuddy -c "Print :ProxiesInBookmarksBar" ~/Library/Preferences/com.apple.Safari.plist) ]] > /dev/null 2>&1
then
	#echo no
	:
else
    #echo yes
    /usr/libexec/PlistBuddy ~/Library/Preferences/com.apple.Safari.plist -c 'Delete ProxiesInBookmarksBar'
fi

# enable add bonjour to favorites
#/usr/libexec/PlistBuddy ~/Library/Preferences/com.apple.Safari.plist -c 'Delete ProxiesInBookmarksBar'
#/usr/libexec/PlistBuddy ~/Library/Preferences/com.apple.Safari.plist -c 'Add ProxiesInBookmarksBar array'
#/usr/libexec/PlistBuddy ~/Library/Preferences/com.apple.Safari.plist -c 'Add ProxiesInBookmarksBar:"Item 0" string "Reading List"'
#/usr/libexec/PlistBuddy ~/Library/Preferences/com.apple.Safari.plist -c 'Add ProxiesInBookmarksBar:"Item 1" string "Top Sites"'
#/usr/libexec/PlistBuddy ~/Library/Preferences/com.apple.Safari.plist -c 'Add ProxiesInBookmarksBar:"Item 2" string "Bonjour"'
...
# display "found in apps" calendar
