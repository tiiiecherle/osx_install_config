...
#sed -i '' '/^Enter the/d' "$FILEVAULT_KEYFILE"
    ...
    tell application "System Preferences"
    	...
    	delay 1
    	tell application "System Events"
    		select row 20 of table 1 of scroll area 1 of tab group 1 of window 1 of application process "System Preferences"
    	end tell
...
EOF
    ...
    sudo defaults write com.apple.smartcharging.topoffprotection enabled -bool true
