...
tell application "Terminal"
	...
	do script "export SELECTEDUSER=\"$SELECTEDUSER\"; export FILESTARGZSAVEDIR=\"$FILESTARGZSAVEDIR\"; export FILESAPPLESCRIPTDIR=\"$FILESAPPLESCRIPTDIR\"; time bash \"$FILESAPPLESCRIPTDIR/files/backup_files.sh\"" in newTab
	delay 10
